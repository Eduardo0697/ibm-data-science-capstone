...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered = spacex_df.groupby(['Launch Site','class']).count().reset_index()
        filtered = filtered[filtered['Launch Site'] == entered_site]
        fig = px.pie(filtered, values='Flight Number', 
        names='class', 
...
def get_scatter_chart(entered_site, payload_value):
    print(entered_site, payload_value[0], payload_value[1])
